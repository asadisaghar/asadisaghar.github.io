...
And last, but not least (actually the mopst exciting for me as I'm just learning about it!), let's use a network of Long-Short Term Memory cells to do the same classification job.

- [LSTM classification](https://github.com/asadisaghar/PdM-C-MAPSST/blob/master/play/publish/LSTM_classification.ipynb)
